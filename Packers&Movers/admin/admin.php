                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                      ...
                      <div class="bottom-border pb-3">
                        ...
                        <a href="#" class="text-white">VAST</a>
                      </div>
                      <ul class="navbar-nav flex-column mt-4">
                        ...
                        <ul id="services" class="collapse">
                          <li class="flex-column mt-2 bass">
                            <a href="allservices.php" class="text-white ml-5">View All Services</a><br><hr>
                            <a href="addservice.php" class="text-white ml-5">Add Services</a><hr>
                          </li>
                        </ul>
                        </li>

                        <li class="nav-item"><a href="book.php" class="nav-link text-white p-3 mb-2 sidebar-link"  data-target="#booking"><i class="fas fa-book text-light fa-lg mr-3"></i class="fas fa-user text-light fa-lg mr-3">Booking<i ></i></a></li>
                        <ul id="services" class="collapse">
                        ...
                        <li class="nav-item"><a href="reports.php" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-folder text-light fa-lg mr-3"></i>Reports</a></li>
                        <li class="nav-item"><a href="approved.php" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-folder text-light fa-lg mr-3"></i>Approved Booking</a></li>
<li class="nav-item"><a href="rejected.php" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-folder text-light fa-lg mr-3"></i>Rejected</a></li>
                      </ul>
                    </div>
                    <!-- end of sidebar -->
                            ...
                            <div class="d-flex justify-content-between">
                              ...
                              <div class="text-right text-secondary">
                                ...
                                <?php
                                  ...
                                  $booking_counts = mysqli_num_rows($client);
                                  echo "<h3>{$booking_counts}</h3>";
                                 ?>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="d-flex justify-content-between">
                              ...
                              <div class="text-right text-secondary">
                                ...
                                <?php
                                  ...
                                  $services_counts = mysqli_num_rows($select_services);
                                  echo "<h3>{$services_counts}</h3>";
                                 ?>
                            ...
                            <div class="d-flex justify-content-between">
                              ...
                              <div class="text-right text-secondary">
                                ...
                                <?php
                                  ...
                                  $report_counts = mysqli_num_rows($server);
                                  echo "<h3>{$report_counts}</h3>";
                                 ?>
