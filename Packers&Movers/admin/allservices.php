              ...
              <div class="col-xl-8 col-sm-6 p-2">
                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    echo "<tr>";
                      echo "<td>$ser_id</td>";
                      echo "<td><img width = '100' src='{$ser_image}'></td>";
                      echo "<td>$title</td>";
                      ...
                      <td>
                        <form class="" action="code.php" method="post">
                          <input type="hidden" name="delete_id" value="<?php echo $row['ser_id']; ?>">
                          <button type="submit" name="delete_btn" class="btn btn-danger" name="button">Delete</button>
                        </form>
                      </td>
                      <?php
                    echo "</tr>";
