...
<html lang="en">
  ...
  <body>
    ...
    <section>
  <div class="container-fluid">
    <div class="row justify-content-center mt-3 ml-1 mr-5">
      <div class="col-xl-10 col-lg-12 col-md-8 ml-auto">
        <div class="row pt-md-5 mt-md-3 mb-5">
          ...
          if(isset($_POST['editbtn']))
          {
              ...
              $query = "SELECT * FROM customer WHERE phone_no = '$id' ";
              $select_customer = mysqli_query($connection,$query);

            foreach ($select_customer as $row) {

          ?>
          <div class="container-fluid">
             <div class="row justify-content-center mt-5 ml-5 ">
          <form style="border: 2px solid black;" class="bg-light" action="code.php" method="post" enctype="multipart/form-data">
            <div class="form-group mt-5 ml-4 mr-4 mb-3">
              <input type="hidden" name="edit_status" value="<?php echo $row['phone_no'];?>"
              <label for="">Phone no.</label>
              <input type="text" name="edit_phone no." class="form-control mb-3" value="<?php echo $row['phone_no']; ?>">

            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <label class="input-group-text" for="inputGroupSelect01">Status</label>
              </div>
              <select class="custom-select" id="inputGroupSelect01" name="cus_status">
            ...
            <button type="submit" name="updatebtn" class="btn btn-success" name="button">Update</button>
          </div>
          </div>
   </div>
</div>
