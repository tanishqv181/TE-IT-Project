              ...
              <ul class="navbar-nav flex-column mt-4">
                ...
                <ul id="services" class="collapse">
                  <li class="flex-column mt-2 bass">
                    ...
                    <a href="#" class="text-white ml-5">Add Services</a><hr>
                  </li>
                </ul>
                </li>
        ...
        <div class="row">
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row pt-md-5 mt-md-3 mb-5">
              <div class="col-xl-8 col-sm-6 p-2">
...
if(isset($_POST['create_service'])) {
  ...
  $ser_image_temp = $_FILES['image']['tmp_name'];
  $description = $_POST['description'];
  $cost = $_POST['cost'];


  move_uploaded_file($ser_image_temp, "$ser_image");

  $query = "INSERT INTO services(ser_id,ser_image,title,description,cost)";
  $query.= "VALUES('{$ser_id}','{$ser_image}','{$title}','{$description}','{$cost}')";
...
?>
              ...
              <form class="" action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="service-id">Service_ID</label>
                  <input type="text" name="ser_id" class="form-control" value="">
                </div>
                ...
                <div class="form-group">
                  <label for="ser_image">Image</label>
                ...
                <div class="form-group">
                  <input type="submit" class ="btn btn-primary" name="create_service"  value="Publish">
                </div>
